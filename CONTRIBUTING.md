...
Discussion of this work occurs on the [Secure Shell Maintenance
Working Group mailing list](mailto:ssh@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/ssh/),
[subscribe](https://mailman3.ietf.org/mailman3/lists/ssh.ietf.org/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/sshm/documents/).
